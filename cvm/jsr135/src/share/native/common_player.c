...
JNIEXPORT jobjectArray JNICALL Java_jsr135_MaemoMediaPlayer_maemoMediaPlayer(JNIEnv *env, jclass clazz, jobjectArray params) {
    return invokePlatform(env, clazz, params);
}
