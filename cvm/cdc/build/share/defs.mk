...
#harmattan: for JCC command. JCC, 应该不必要
...
CVM_JCC_APILISTER_OPTIONS	+= -listapi:include=java/*,include=javax/*,include=com/nokia/*,input=$(CVM_MIDPFILTERINPUT),mout=$(CVM_MIDPFILTERCONFIG),cout=$(CVM_MIDPCLASSLIST)
else
...
#harmattan: for build shared library. 编译动态库
ifeq ($(CVM_BUILD_SO),true)
CCFLAGS += -fPIC
CCCFLAGS += -fPIC
endif
...
SO_LINKFLAGS 	= $(LINKFLAGS) -shared -fPIC #harmattan: for build shared library. 编译动态库
