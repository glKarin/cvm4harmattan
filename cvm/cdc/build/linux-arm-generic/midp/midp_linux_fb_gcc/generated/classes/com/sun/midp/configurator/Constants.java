...
public class Constants {
     ...
     */
    public final static int CHAM_WIDTH = 480;

    /**
     * (Chameleon Only) full display width
     */
    public final static int CHAM_FULLWIDTH = 480;

    /**
     * (Chameleon Only) display height
     */
    public final static int CHAM_HEIGHT = 720;

    /**
     * (Chameleon Only) full display height
     */
    public final static int CHAM_FULLHEIGHT = 720;
     ...
     */
    public final static int FULLWIDTH = 480;

    /**
     * (Fixed) full display height
     */
    public final static int FULLHEIGHT = 720;

    /**
     * (Fixed) normal width
     */
    public final static int NORMALWIDTH = 480;

    /**
     * (Fixed) normal height
     */
    public final static int NORMALHEIGHT = 720;
     ...
     * No debug.
     */
    public final static int MIDP_NO_DEBUG = 0;

    /**
     * Debug: suspend the VM until the debugger sends a continue command.
     */
    public final static int MIDP_DEBUG_SUSPEND = 1;

    /**
     * Debug: do not wait for the debugger.
     */
    public final static int MIDP_DEBUG_NO_SUSPEND = 2;
     ...
     */
    public final static int MAX_STORAGE_NUM = 1;
     ...
     */
    public final static boolean FINGER_TOUCH = true;
