...
public class EventQueue implements Runnable {
    ...
    /**
     * Constructs and starts the primary event queue for this isolate.
     */
    static {
    ...
    /**
     * Constructs an event queue. It creates the event threads, 
     * but it doesn't start them.
     */
    EventQueue() {
        /*
        ...
        queueId = getNativeEventQueueHandle();
     ...
     */
    private static native void resetNativeEventQueue(int queueId);
            ...
            for (; ; ) {
                ...
                synchronized (eventQueueLock) {
                    ...
                    for (; eventsStillPending > 0; eventsStillPending--) {
                        ...
                        if (!readNativeEvent(nativeEvent, queueId)) {
                            break;
                        }
