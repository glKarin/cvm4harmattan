...
(JNIEnv* aEnv, jclass _unused, jlong aHCompositingMode)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHCompositingMode, jboolean aEnable)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHCompositingMode, jfloat aThreshold)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHCompositingMode, jfloat aFactor, jfloat aUnits)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHCompositingMode, jint aMode)
{
    M3G_DO_LOCK
