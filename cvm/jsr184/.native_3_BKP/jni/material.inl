...
(JNIEnv* aEnv, jclass _unused, jlong aHMaterial)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHMaterial, jboolean aEnable)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHMaterial, jint aTarget, jint aARGB)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHMaterial, jfloat aShininess)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHMaterial, jint aTarget)
{
    M3G_DO_LOCK
