...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jint aLayer)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jlong aHMode)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jint aUnit, jlong aHTex)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jint aUnit)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jlong aHFog)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHApp, jlong aHMaterial)
{
    M3G_DO_LOCK
