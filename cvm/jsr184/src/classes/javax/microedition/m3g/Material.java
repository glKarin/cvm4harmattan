...
public class Material extends Object3D {
	...
	public Material() {
		...
		Object3D.KarinDebugCall(this, "public Material() {");
	}
	...
	Material(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Material(long handle) {");
	}
	...
	public void setColor(int target, int ARGB) {
		Object3D.KarinDebugCall(this, "public void setColor(int target, int ARGB) {");
		_setColor(handle, target, ARGB);
	}

	public int getColor(int target) {
		Object3D.KarinDebugCall(this, "public int getColor(int target) {");
		return _getColor(handle, target);
	}

	public void setShininess(float shininess) {
		Object3D.KarinDebugCall(this, "public void setShininess(float shininess) {");
		_setShininess(handle, shininess);
	}

	public float getShininess() {
		Object3D.KarinDebugCall(this, "public float getShininess() {");
		return _getShininess(handle);
	}

	public void setVertexColorTrackingEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setVertexColorTrackingEnable(boolean enable) {");
		_setVertexColorTrackingEnable(handle, enable);
	}

	public boolean isVertexColorTrackingEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isVertexColorTrackingEnabled() {");
