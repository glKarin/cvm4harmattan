...
public class SkinnedMesh extends Mesh {
	...
	public SkinnedMesh(VertexBuffer vertices,
		...
		Object3D.KarinDebugCall(this, "public SkinnedMesh(VertexBuffer vertices, IndexBuffer[] triangles, Appearance[] appearances, Group skeleton) {");
	...
	public SkinnedMesh(VertexBuffer vertices,
		...
		Object3D.KarinDebugCall(this, "public SkinnedMesh(VertexBuffer vertices, IndexBuffer triangles, Appearance appearance, Group skeleton) {");
		skeleton.setParent(this);
		this.skeleton = skeleton;
	}
	...
	SkinnedMesh(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "SkinnedMesh(long handle) {");
	...
	public void addTransform(Node bone,
							 ...
							 int firstVertex,
							 int numVertices) {
		Object3D.KarinDebugCall(this, "public void addTransform(Node bone, int weight, int firstVertex, int numVertices) {");
	...
	public Group getSkeleton() {
		Object3D.KarinDebugCall(this, "public Group getSkeleton() {");
		return skeleton;
	}
	...
	public void getBoneTransform(Node bone, Transform transform) {
		Object3D.KarinDebugCall(this, "public void getBoneTransform(Node bone, Transform transform) {");
		_getBoneTransform(handle, bone.handle, transform.matrix);
	}

	public int getBoneVertices(Node bone, int[] indices, float[] weights) {
		Object3D.KarinDebugCall(this, "public int getBoneVertices(Node bone, int[] indices, float[] weights) {");
	...
	static long createHandle(VertexBuffer vertices,
							...
							Appearance[] appearances,
							Group skeleton) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer vertices, IndexBuffer[] triangles, Appearance[] appearances, Group skeleton) {");
	...
	static long createHandle(VertexBuffer vertices,
							...
							Appearance appearance,
							Group skeleton) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer vertices, IndexBuffer triangles, Appearance appearance, Group skeleton) {");
