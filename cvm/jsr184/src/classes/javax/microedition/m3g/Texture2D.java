...
public class Texture2D extends Transformable {
	...
	public Texture2D(final Image2D image) {
		...
		Object3D.KarinDebugCall(this, "public Texture2D(final Image2D image) {");
		this.image = image;
	}
	...
	Texture2D(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Texture2D(long handle) {");
	...
	public void setImage(final Image2D image) {
		Object3D.KarinDebugCall(this, "public void setImage(final Image2D image) {");
	...
	public void setFiltering(int levelFilter, int imageFilter) {
		Object3D.KarinDebugCall(this, "public void setFiltering(int levelFilter, int imageFilter) {");
		_setFiltering(handle, levelFilter, imageFilter);
	}

	public void setWrapping(int wrapS, int wrapT) {
		Object3D.KarinDebugCall(this, "public void setWrapping(int wrapS, int wrapT) {");
		_setWrapping(handle, wrapS, wrapT);
	}

	public int getWrappingS() {
		Object3D.KarinDebugCall(this, "public int getWrappingS() {");
		return _getWrappingS(handle);
	}

	public int getWrappingT() {
		Object3D.KarinDebugCall(this, "public int getWrappingT() {");
		return _getWrappingT(handle);
	}

	public void setBlending(int func) {
		Object3D.KarinDebugCall(this, "public void setBlending(int func) {");
	...
	public void setBlendColor(int RGB) {
		Object3D.KarinDebugCall(this, "public void setBlendColor(int RGB) {");
		_setBlendColor(handle, RGB);
	}

	public int getBlendColor() {
		Object3D.KarinDebugCall(this, "public int getBlendColor() {");
	...
	public int getImageFilter() {
		Object3D.KarinDebugCall(this, "public int getImageFilter() {");
		return _getImageFilter(handle);
	}

	public int getLevelFilter() {
		Object3D.KarinDebugCall(this, "public int getLevelFilter() {");
