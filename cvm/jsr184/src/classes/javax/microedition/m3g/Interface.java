...
//#endif // RD_JAVA_OMJ
	...
	private Interface() {
		Object3D.KarinDebugCall(this, "private Interface() {");
...
//#endif // RD_JAVA_OMJ
	...
	static final Interface getInstance() {
		Object3D.KarinDebugCall(null, "static final Interface getInstance() {");
		if (instance == null) {
	...
	static final long getHandle() {
		Object3D.KarinDebugCall(null, "static final long getHandle() {");
	...
	static final void register(Object3D obj) {
		Object3D.KarinDebugCall(null, "static final void register(Object3D obj) {");
		getInstance().liveObjects.put(new Long(obj.handle),
				new WeakReference(obj));
	}

	static final void register(Loader obj) {
		Object3D.KarinDebugCall(null, "static final void register(Loader obj) {");
		getInstance().liveObjects.put(new Long(obj.handle),
				new WeakReference(obj));
	}
	...
	static final Object3D findObject(long handle) {
		Object3D.KarinDebugCall(null, "static final Object3D findObject(long handle) {");
	...
	static final Object3D getObjectInstance(long handle) {
		Object3D.KarinDebugCall(null, "static final Object3D getObjectInstance(long handle) {");
	...
	static final void deregister(Object3D obj, Interface self) {
		Object3D.KarinDebugCall(null, "static final void deregister(Object3D obj, Interface self) {");
	...
	static final void deregister(Loader obj, Interface self) {
		Object3D.KarinDebugCall(null, "static final void deregister(Loader obj, Interface self) {");
		self.liveObjects.remove(new Long(obj.handle));
		if (self.liveObjects.isEmpty() && self.iShutdown) {
			self.registeredFinalize();
		}
	 ...
	 */
	void signalShutdown() {
		Object3D.KarinDebugCall(this, "void signalShutdown() {");
		iShutdown = true;
	}
	...
	boolean isFullyInitialized() {
		Object3D.KarinDebugCall(this, "boolean isFullyInitialized() {");
...
//#endif // RD_JAVA_OMJ
	...
	final private void registeredFinalize() {
		Object3D.KarinDebugCall(this, "final private void registeredFinalize() {");
