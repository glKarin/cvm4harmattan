...
public abstract class Transformable extends Object3D {
	...
	Transformable(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Transformable(long handle) {");
	}
	...
	public void setOrientation(float angle, float ax, float ay, float az) {
		Object3D.KarinDebugCall(this, "public void setOrientation(float angle, float ax, float ay, float az) {");
		_setOrientation(handle, angle, ax, ay, az, true);
	}

	public void postRotate(float angle, float ax, float ay, float az) {
		Object3D.KarinDebugCall(this, "public void postRotate(float angle, float ax, float ay, float az) {");
		_setOrientation(handle, angle, ax, ay, az, false);
	}

	public void preRotate(float angle, float ax, float ay, float az) {
		Object3D.KarinDebugCall(this, "public void preRotate(float angle, float ax, float ay, float az) {");
		_preRotate(handle, angle, ax, ay, az);
	}

	public void getOrientation(float[] angleAxis) {
		Object3D.KarinDebugCall(this, "public void getOrientation(float[] angleAxis) {");
		_getOrientation(handle, angleAxis);
	}

	public void setScale(float sx, float sy, float sz) {
		Object3D.KarinDebugCall(this, "public void setScale(float sx, float sy, float sz) {");
		_setScale(handle, sx, sy, sz, true);
	}

	public void scale(float sx, float sy, float sz) {
		Object3D.KarinDebugCall(this, "public void scale(float sx, float sy, float sz) {");
		_setScale(handle, sx, sy, sz, false);
	}

	public void getScale(float[] xyz) {
		Object3D.KarinDebugCall(this, "public void getScale(float[] xyz) {");
		_getScale(handle, xyz);
	}

	public void setTranslation(float tx, float ty, float tz) {
		Object3D.KarinDebugCall(this, "public void setTranslation(float tx, float ty, float tz) {");
		_setTranslation(handle, tx, ty, tz, true);
	}

	public void translate(float tx, float ty, float tz) {
		Object3D.KarinDebugCall(this, "public void translate(float tx, float ty, float tz) {");
		_setTranslation(handle, tx, ty, tz, false);
	}

	public void getTranslation(float[] xyz) {
		Object3D.KarinDebugCall(this, "public void getTranslation(float[] xyz) {");
		_getTranslation(handle, xyz);
	}

	public void setTransform(Transform transform) {
		Object3D.KarinDebugCall(this, "public void setTransform(Transform transform) {");
		_setTransform(handle, (transform != null) ? transform.matrix : null);
	}

	public void getTransform(Transform transform) {
		Object3D.KarinDebugCall(this, "public void getTransform(Transform transform) {");
		_getTransform(handle, transform.matrix);
	}

	public void getCompositeTransform(Transform transform) {
		Object3D.KarinDebugCall(this, "public void getCompositeTransform(Transform transform) {");
