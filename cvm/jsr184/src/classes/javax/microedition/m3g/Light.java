...
public class Light extends Node {
	...
	public Light() {
		...
		Object3D.KarinDebugCall(this, "public Light() {");
	}
	...
	Light(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Light(long handle) {");
	}

	public void setIntensity(float intensity) {
		Object3D.KarinDebugCall(this, "public void setIntensity(float intensity) {");
		_setIntensity(handle, intensity);
	}

	public float getIntensity() {
		Object3D.KarinDebugCall(this, "public float getIntensity() {");
	...
	public void setSpotAngle(float angle) {
		Object3D.KarinDebugCall(this, "public void setSpotAngle(float angle) {");
		_setSpotAngle(handle, angle);
	}

	public float getSpotAngle() {
		Object3D.KarinDebugCall(this, "public float getSpotAngle() {");
		return _getSpotAngle(handle);
	}

	public void setSpotExponent(float exponent) {
		Object3D.KarinDebugCall(this, "public void setSpotExponent(float exponent) {");
		_setSpotExponent(handle, exponent);
	}

	public float getSpotExponent() {
		Object3D.KarinDebugCall(this, "public float getSpotExponent() {");
		return _getSpotExponent(handle);
	}

	public void setAttenuation(float constant, float linear, float quadratic) {
		Object3D.KarinDebugCall(this, "public void setAttenuation(float constant, float linear, float quadratic) {");
		_setAttenuation(handle, constant, linear, quadratic);
	}

	public float getConstantAttenuation() {
		Object3D.KarinDebugCall(this, "public float getConstantAttenuation() {");
		return _getAttenuation(handle, Defs.GET_CONSTANT);
	}

	public float getLinearAttenuation() {
		Object3D.KarinDebugCall(this, "public float getLinearAttenuation() {");
		return _getAttenuation(handle, Defs.GET_LINEAR);
	}

	public float getQuadraticAttenuation() {
		Object3D.KarinDebugCall(this, "public float getQuadraticAttenuation() {");
