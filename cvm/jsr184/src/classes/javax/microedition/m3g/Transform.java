...
public class Transform {
	...
	public Transform() {
		Object3D.KarinDebugCall(this, "public Transform() {");
	...
	public Transform(Transform other) {
		Object3D.KarinDebugCall(this, "public Transform(Transform other) {");
		if (!Platform.uiThreadAvailable()) {
			throw new Error("UI thread not initialized");
		}
		set(other);
	...
	public void setIdentity() {
		Object3D.KarinDebugCall(this, "public void setIdentity() {");
		_setIdentity(matrix);
	}

	public void set(Transform transform) {
		Object3D.KarinDebugCall(this, "public void set(Transform transform) {");
	...
	public void set(float[] matrix) {
		Object3D.KarinDebugCall(this, "public void set(float[] matrix) {");
		_setMatrix(this.matrix, matrix);
	}

	public void get(float[] matrix) {
		Object3D.KarinDebugCall(this, "public void get(float[] matrix) {");
		_getMatrix(this.matrix, matrix);
	}

	public void invert() {
		Object3D.KarinDebugCall(this, "public void invert() {");
		_invert(matrix);
	}

	public void transpose() {
		Object3D.KarinDebugCall(this, "public void transpose() {");
		_transpose(matrix);
	}

	public void postMultiply(Transform transform) {
		Object3D.KarinDebugCall(this, "public void postMultiply(Transform transform) {");
		_mul(this.matrix, this.matrix, transform.matrix);
	}

	public void postScale(float sx, float sy, float sz) {
		Object3D.KarinDebugCall(this, "public void postScale(float sx, float sy, float sz) {");
	...
	public void postRotateQuat(float qx, float qy, float qz, float qw) {
		Object3D.KarinDebugCall(this, "public void postRotateQuat(float qx, float qy, float qz, float qw) {");
	...
	public void postTranslate(float tx, float ty, float tz) {
		Object3D.KarinDebugCall(this, "public void postTranslate(float tx, float ty, float tz) {");
	...
	public void transform(float[] v) {
		Object3D.KarinDebugCall(this, "public void transform(float[] v) {");
		if ((v.length % 4) != 0) {
	...
	public void transform(VertexArray in, float[] out, boolean W) {
		Object3D.KarinDebugCall(this, "public void transform(VertexArray in, float[] out, boolean W) {");
		if (in == null || out == null) {
