...
public class World extends Group {
	...
	public World() {
		...
		Object3D.KarinDebugCall(this, "public World() {");
	}
	...
	World(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "World(long handle) {");
	...
	public void setBackground(Background background) {
		Object3D.KarinDebugCall(this, "public void setBackground(Background background) {");
		_setBackground(handle, background != null ? background.handle : 0);
		this.background = background;
	}

	public Background getBackground() {
		Object3D.KarinDebugCall(this, "public Background getBackground() {");
		return background;
	}

	public void setActiveCamera(Camera camera) {
		Object3D.KarinDebugCall(this, "public void setActiveCamera(Camera camera) {");
		_setActiveCamera(handle, camera != null ? camera.handle : 0);
		this.activeCamera = camera;
	}

	public Camera getActiveCamera() {
		Object3D.KarinDebugCall(this, "public Camera getActiveCamera() {");
		return activeCamera;
	}
