...
public class Background extends Object3D {
	...
	public Background() {
		...
		Object3D.KarinDebugCall(this, "public Background() {");
	}
	...
	Background(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Background(long handle) {");
	...
	public void setColor(int ARGB) {
		Object3D.KarinDebugCall(this, "public void setColor(int ARGB) {");
	...
	public void setImage(Image2D image) {
		Object3D.KarinDebugCall(this, "public void setImage(Image2D image) {");
		_setImage(handle, image != null ? image.handle : 0);
		this.image = image;
	}

	public Image2D getImage() {
		Object3D.KarinDebugCall(this, "public Image2D getImage() {");
		return image;
	}

	public void setImageMode(int modeX, int modeY) {
		Object3D.KarinDebugCall(this, "public void setImageMode(int modeX, int modeY) {");
		_setImageMode(handle, modeX, modeY);
	}

	public int getImageModeX() {
		Object3D.KarinDebugCall(this, "public int getImageModeX() {");
		return _getImageMode(handle, Defs.GET_MODEX);
	}

	public int getImageModeY() {
		Object3D.KarinDebugCall(this, "public int getImageModeY() {");
		return _getImageMode(handle, Defs.GET_MODEY);
	}

	public void setColorClearEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setColorClearEnable(boolean enable) {");
		_enable(handle, Defs.SETGET_COLORCLEAR, enable);
	}

	public void setDepthClearEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setDepthClearEnable(boolean enable) {");
		_enable(handle, Defs.SETGET_DEPTHCLEAR, enable);
	}

	public boolean isColorClearEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isColorClearEnabled() {");
		return _isEnabled(handle, Defs.SETGET_COLORCLEAR);
	}

	public boolean isDepthClearEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isDepthClearEnabled() {");
		return _isEnabled(handle, Defs.SETGET_DEPTHCLEAR);
	}

	public void setCrop(int cropX, int cropY, int width, int height) {
		Object3D.KarinDebugCall(this, "public void setCrop(int cropX, int cropY, int width, int height) {");
		_setCrop(handle, cropX, cropY, width, height);
	}

	public int getCropX() {
		Object3D.KarinDebugCall(this, "public int getCropX() {");
		return _getCrop(handle, Defs.GET_CROPX);
	}

	public int getCropY() {
		Object3D.KarinDebugCall(this, "public int getCropY() {");
		return _getCrop(handle, Defs.GET_CROPY);
	}

	public int getCropWidth() {
		Object3D.KarinDebugCall(this, "public int getCropWidth() {");
		return _getCrop(handle, Defs.GET_CROPWIDTH);
	}

	public int getCropHeight() {
		Object3D.KarinDebugCall(this, "public int getCropHeight() {");
