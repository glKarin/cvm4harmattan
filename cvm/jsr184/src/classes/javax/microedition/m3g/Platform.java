...
class Platform {
	...
	static void executeInUIThread(M3gRunnable obj) {
		Object3D.KarinDebugCall(null, "static void executeInUIThread(M3gRunnable obj) {");
	...
	static boolean uiThreadAvailable() {
		Object3D.KarinDebugCall(null, "static boolean uiThreadAvailable() {");
		{
			// UI thread is available, so load native library if not already loaded
			if (!libraryLoaded) {
			//k System.loadLibrary("javam3g");
				_initGL(1);
				libraryLoaded = true;
			}
			return true;
	...
	static final void registerFinalizer(Object3D obj) {
		Object3D.KarinDebugCall(null, "static final void registerFinalizer(Object3D obj) {");
		//heuristicGC();
	}
	...
	static final void registerFinalizer(Graphics3D g3d) {
		Object3D.KarinDebugCall(null, "static final void registerFinalizer(Graphics3D g3d) {");
		//heuristicGC();
	}
	...
	static final void registerFinalizer(Interface m3g) {
		Object3D.KarinDebugCall(null, "static final void registerFinalizer(Interface m3g) {");
	}
	...
	static final void registerFinalizer(Loader loader) {
		Object3D.KarinDebugCall(null, "static final void registerFinalizer(Loader loader) {");
	}
	...
	static final void sync(Graphics g) {
		Object3D.KarinDebugCall(null, "static final void sync(Graphics g) {");
	...
	static final void sync(Image img) {
		Object3D.KarinDebugCall(null, "static final void sync(Image img) {");
		//ToolkitInvoker invoker = ToolkitInvoker.getToolkitInvoker();
		//invoker.toolkitSync(invoker.getToolkit());
	}
	...
	static final void finalizeObject(long handle) {
		Object3D.KarinDebugCall(null, "static final void finalizeObject(long handle) {");
		try {
	...
	static final void finalizeObject(long handle, Interface aInterface) {
		Object3D.KarinDebugCall(null, "static final void finalizeObject(long handle, Interface aInterface) {");
		try {
			final long finalHandle = handle;
			executeInUIThread(
					new M3gRunnable() {
	...
	static final void heuristicGC() {
		Object3D.KarinDebugCall(null, "static final void heuristicGC() {");
	}

	private static final native void _finalizeObject(long handle);

	//k
	private static final native boolean _initGL(int gl);
	private static final native void _shutdownGL();
}
