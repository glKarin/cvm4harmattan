...
public class Sprite3D extends Node {
	...
	public Sprite3D(boolean scaled, Image2D image, Appearance appearance) {
		...
		Object3D.KarinDebugCall(this, "public Sprite3D(boolean scaled, Image2D image, Appearance appearance) {");
		this.image = image;
	...
	Sprite3D(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Sprite3D(long handle) {");
	...
	public boolean isScaled() {
		Object3D.KarinDebugCall(this, "public boolean isScaled() {");
		return _isScaled(handle);
	}

	public void setAppearance(Appearance appearance) {
		Object3D.KarinDebugCall(this, "public void setAppearance(Appearance appearance) {");
		_setAppearance(handle, appearance != null ? appearance.handle : 0);
		this.appearance = appearance;
	}

	public Appearance getAppearance() {
		Object3D.KarinDebugCall(this, "public Appearance getAppearance() {");
		return appearance;
	}
