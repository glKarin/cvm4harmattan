...
public class AnimationTrack extends Object3D {
	...
	AnimationTrack(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "AnimationTrack(long handle) {");
	...
	public AnimationTrack(KeyframeSequence sequence, int property) {
		...
		Object3D.KarinDebugCall(this, "public AnimationTrack(KeyframeSequence sequence, int property) {");
	...
	public void setController(AnimationController controller) {
		Object3D.KarinDebugCall(this, "public void setController(AnimationController controller) {");
		_setController(handle, controller != null ? controller.handle : 0);
		this.controller = controller;
	}

	public AnimationController getController() {
		Object3D.KarinDebugCall(this, "public AnimationController getController() {");
		return controller;
	}

	public KeyframeSequence getKeyframeSequence() {
		Object3D.KarinDebugCall(this, "public KeyframeSequence getKeyframeSequence() {");
		return sequence;
	}

	public int getTargetProperty() {
		Object3D.KarinDebugCall(this, "public int getTargetProperty() {");
