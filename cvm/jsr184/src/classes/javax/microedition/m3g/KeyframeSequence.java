...
public class KeyframeSequence extends Object3D {
	...
	public KeyframeSequence(int numKeyframes,
		...
		super(_ctor(Interface.getHandle(),
				...
				numComponents,
				interpolation));
		Object3D.KarinDebugCall(this, "public KeyframeSequence(int numKeyframes, int numComponents, int interpolation) {");
	}
	...
	KeyframeSequence(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "KeyframeSequence(long handle) {");
	}
	...
	public void setKeyframe(int index, int time, float[] value) {
		Object3D.KarinDebugCall(this, "public void setKeyframe(int index, int time, float[] value) {");
		_setKeyframe(handle, index, time, value);
	}

	public void setValidRange(int first, int last) {
		Object3D.KarinDebugCall(this, "public void setValidRange(int first, int last) {");
		_setValidRange(handle, first, last);
	}

	public void setDuration(int duration) {
		Object3D.KarinDebugCall(this, "public void setDuration(int duration) {");
		_setDuration(handle, duration);
	}

	public int getDuration() {
		Object3D.KarinDebugCall(this, "public int getDuration() {");
	...
	public void setRepeatMode(int mode) {
		Object3D.KarinDebugCall(this, "public void setRepeatMode(int mode) {");
	...
	public int getRepeatMode() {
		Object3D.KarinDebugCall(this, "public int getRepeatMode() {");
	...
	public int getComponentCount() {
		Object3D.KarinDebugCall(this, "public int getComponentCount() {");
		return _getComponentCount(handle);
	}

	public int getInterpolationType() {
		Object3D.KarinDebugCall(this, "public int getInterpolationType() {");
		return _getInterpolationType(handle);
	}

	public int getKeyframe(int index, float[] value) {
		Object3D.KarinDebugCall(this, "public int getKeyframe(int index, float[] value) {");
		return _getKeyframe(handle, index, value);
	}

	public int getKeyframeCount() {
		Object3D.KarinDebugCall(this, "public int getKeyframeCount() {");
		return _getKeyframeCount(handle);
	}

	public int getValidRangeFirst() {
		Object3D.KarinDebugCall(this, "public int getValidRangeFirst() {");
		return _getValidRangeFirst(handle);
	}

	public int getValidRangeLast() {
		Object3D.KarinDebugCall(this, "public int getValidRangeLast() {");
