...
public abstract class Node extends Transformable {
	...
	Node(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Node(long handle) {");
	...
	public Node getParent() {
		Object3D.KarinDebugCall(this, "public Node getParent() {");
		return parent;
	}

	public boolean getTransformTo(Node target, Transform transform) {
		Object3D.KarinDebugCall(this, "public boolean getTransformTo(Node target, Transform transform) {");
	...
	public void setAlignment(Node zReference, int zTarget,
		...
		Object3D.KarinDebugCall(this, "public void setAlignment(Node zReference, int zTarget, Node yReference, int yTarget) {");
	...
	public void setAlphaFactor(float alphaFactor) {
		Object3D.KarinDebugCall(this, "public void setAlphaFactor(float alphaFactor) {");
		_setAlphaFactor(handle, alphaFactor);
	}

	public float getAlphaFactor() {
		Object3D.KarinDebugCall(this, "public float getAlphaFactor() {");
		return _getAlphaFactor(handle);
	}

	public void setRenderingEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setRenderingEnable(boolean enable) {");
		_enable(handle, Defs.SETGET_RENDERING, enable);
	}

	public boolean isRenderingEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isRenderingEnabled() {");
		return _isEnabled(handle, Defs.SETGET_RENDERING);
	}

	public void setPickingEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setPickingEnable(boolean enable) {");
		_enable(handle, Defs.SETGET_PICKING, enable);
	}

	public boolean isPickingEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isPickingEnabled() {");
		return _isEnabled(handle, Defs.SETGET_PICKING);
	}

	public void setScope(int id) {
		Object3D.KarinDebugCall(this, "public void setScope(int id) {");
		_setScope(handle, id);
	}

	public int getScope() {
		Object3D.KarinDebugCall(this, "public int getScope() {");
		return _getScope(handle);
	}

	public final void align(Node reference) {
		Object3D.KarinDebugCall(this, "public final void align(Node reference) {");
	...
	public Node getAlignmentReference(int axis) {
		Object3D.KarinDebugCall(this, "public Node getAlignmentReference(int axis) {");
		switch (axis) {
			case Y_AXIS:
				return yRef;
			case Z_AXIS:
	...
	public int getAlignmentTarget(int axis) {
		Object3D.KarinDebugCall(this, "public int getAlignmentTarget(int axis) {");
	...
	void setParent(Node parent) {
		Object3D.KarinDebugCall(this, "void setParent(Node parent) {");
		this.parent = parent;
	}
