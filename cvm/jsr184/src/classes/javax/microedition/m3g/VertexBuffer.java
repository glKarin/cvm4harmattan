...
public class VertexBuffer extends Object3D {
	...
	public VertexBuffer() {
		...
		Object3D.KarinDebugCall(this, "public VertexBuffer() {");
	}
	...
	VertexBuffer(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "VertexBuffer(long handle) {");
	...
	public int getVertexCount() {
		Object3D.KarinDebugCall(this, "public int getVertexCount() {");
		return _getVertexCount(handle);
	}

	public void setPositions(VertexArray positions, float scale, float[] bias) {
		try{
		Object3D.KarinDebugCall(this, "public void setPositions(VertexArray positions, float scale, float[] bias) {");
		System.out.println("Java setVertices -------------------->bias " + (bias != null ? bias.length + "": "NULL"));
		_setVertices(handle,
	...
	public void setTexCoords(int index, VertexArray texCoords, float scale, float[] bias) {
		Object3D.KarinDebugCall(this, "public void setTexCoords(int index, VertexArray texCoords, float scale, float[] bias) {");
		System.out.println("Java setTexCoords --------------------> " + (bias != null ? bias.length + "" : "NULL"));
		try
		{
		...
		{
			e.printStackTrace();
			System.out.println("ttttttttttyttpp");
		}
	}

	public void setNormals(VertexArray normals) {
		Object3D.KarinDebugCall(this, "public void setNormals(VertexArray normals) {");
		_setNormals(handle, normals != null ? normals.handle : 0);
		this.normals = normals;
	}

	public void setColors(VertexArray colors) {
		Object3D.KarinDebugCall(this, "public void setColors(VertexArray colors) {");
		_setColors(handle, colors != null ? colors.handle : 0);
		this.colors = colors;
	}

	public VertexArray getPositions(float[] scaleBias) {
		Object3D.KarinDebugCall(this, "public VertexArray getPositions(float[] scaleBias) {");
	...
	public VertexArray getTexCoords(int index, float[] scaleBias) {
		Object3D.KarinDebugCall(this, "public VertexArray getTexCoords(int index, float[] scaleBias) {");
	...
	public VertexArray getNormals() {
		Object3D.KarinDebugCall(this, "public VertexArray getNormals() {");
		return normals;
	}

	public VertexArray getColors() {
		Object3D.KarinDebugCall(this, "public VertexArray getColors() {");
		return colors;
	}

	public void setDefaultColor(int ARGB) {
		Object3D.KarinDebugCall(this, "public void setDefaultColor(int ARGB) {");
		_setDefaultColor(handle, ARGB);
	}

	public int getDefaultColor() {
		Object3D.KarinDebugCall(this, "public int getDefaultColor() {");
