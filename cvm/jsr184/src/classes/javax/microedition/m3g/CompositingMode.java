...
public class CompositingMode extends Object3D {
	...
	public CompositingMode() {
		...
		Object3D.KarinDebugCall(this, "public CompositingMode() {");
	}
	...
	CompositingMode(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "CompositingMode(long handle) {");
	}
	...
	public void setBlending(int mode) {
		Object3D.KarinDebugCall(this, "public void setBlending(int mode) {");
		_setBlending(handle, mode);
	}

	public int getBlending() {
		Object3D.KarinDebugCall(this, "public int getBlending() {");
		return _getBlending(handle);
	}

	public void setAlphaThreshold(float threshold) {
		Object3D.KarinDebugCall(this, "public void setAlphaThreshold(float threshold) {");
		_setAlphaThreshold(handle, threshold);
	}

	public float getAlphaThreshold() {
		Object3D.KarinDebugCall(this, "public float getAlphaThreshold() {");
		return _getAlphaThreshold(handle);
	}

	public void setAlphaWriteEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setAlphaWriteEnable(boolean enable) {");
		_setAlphaWriteEnable(handle, enable);
	}

	public boolean isAlphaWriteEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isAlphaWriteEnabled() {");
		return _isAlphaWriteEnabled(handle);
	}

	public void setColorWriteEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setColorWriteEnable(boolean enable) {");
		_enableColorWrite(handle, enable);
	}

	public boolean isColorWriteEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isColorWriteEnabled() {");
		return _isColorWriteEnabled(handle);
	}

	public void setDepthWriteEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setDepthWriteEnable(boolean enable) {");
		_enableDepthWrite(handle, enable);
	}

	public boolean isDepthWriteEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isDepthWriteEnabled() {");
		return _isDepthWriteEnabled(handle);
	}

	public void setDepthTestEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setDepthTestEnable(boolean enable) {");
		_enableDepthTest(handle, enable);
	}

	public boolean isDepthTestEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isDepthTestEnabled() {");
		return _isDepthTestEnabled(handle);
	}

	public void setDepthOffset(float factor, float units) {
		Object3D.KarinDebugCall(this, "public void setDepthOffset(float factor, float units) {");
		_setDepthOffset(handle, factor, units);
	}

	public float getDepthOffsetFactor() {
		Object3D.KarinDebugCall(this, "public float getDepthOffsetFactor() {");
		return _getDepthOffsetFactor(handle);
	}

	public float getDepthOffsetUnits() {
		Object3D.KarinDebugCall(this, "public float getDepthOffsetUnits() {");
