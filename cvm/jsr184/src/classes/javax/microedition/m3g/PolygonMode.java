...
public class PolygonMode extends Object3D {
	...
	public PolygonMode() {
		...
		Object3D.KarinDebugCall(this, "public PolygonMode() {");
	}
	...
	PolygonMode(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "PolygonMode(long handle) {");
	}
	...
	public void setCulling(int mode) {
		Object3D.KarinDebugCall(this, "public void setCulling(int mode) {");
		_setCulling(handle, mode);
	}

	public int getCulling() {
		Object3D.KarinDebugCall(this, "public int getCulling() {");
		return _getCulling(handle);
	}

	public void setWinding(int mode) {
		Object3D.KarinDebugCall(this, "public void setWinding(int mode) {");
		_setWinding(handle, mode);
	}

	public int getWinding() {
		Object3D.KarinDebugCall(this, "public int getWinding() {");
		return _getWinding(handle);
	}

	public void setShading(int mode) {
		Object3D.KarinDebugCall(this, "public void setShading(int mode) {");
		_setShading(handle, mode);
	}

	public int getShading() {
		Object3D.KarinDebugCall(this, "public int getShading() {");
		return _getShading(handle);
	}

	public void setTwoSidedLightingEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setTwoSidedLightingEnable(boolean enable) {");
		_setTwoSidedLightingEnable(handle, enable);
	}

	public boolean isTwoSidedLightingEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isTwoSidedLightingEnabled() {");
		return _isTwoSidedLightingEnabled(handle);
	}

	public void setLocalCameraLightingEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setLocalCameraLightingEnable(boolean enable) {");
		_setLocalCameraLightingEnable(handle, enable);
	}

	public void setPerspectiveCorrectionEnable(boolean enable) {
		Object3D.KarinDebugCall(this, "public void setPerspectiveCorrectionEnable(boolean enable) {");
	...
	public boolean isLocalCameraLightingEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isLocalCameraLightingEnabled() {");
		return _isLocalCameraLightingEnabled(handle);
	}

	public boolean isPerspectiveCorrectionEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isPerspectiveCorrectionEnabled() {");
