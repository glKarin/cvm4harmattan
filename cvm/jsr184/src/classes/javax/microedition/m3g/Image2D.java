...
public class Image2D extends Object3D {
	...
	public Image2D(int format, Object image) {
		...
		Object3D.KarinDebugCall(this, "public Image2D(int format, Object image) {");
	}

	public Image2D(int format, int width, int height, byte[] image) {
		super(createHandle(format, width, height, image));
		Object3D.KarinDebugCall(this, "public Image2D(int format, int width, int height, byte[] image) {");
	}
	...
	public Image2D(int format,
		...
		Object3D.KarinDebugCall(this, "public Image2D(int format, int width, int height, byte[] image, byte[] palette) {");
	}

	public Image2D(int format, int width, int height) {
		super(createHandle(format, width, height));
		Object3D.KarinDebugCall(this, "public Image2D(int format, int width, int height) {");
	}

	Image2D(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Image2D(long handle) {");
	}
	...
	public void set(int x, int y, int width, int height, byte[] image) {
		Object3D.KarinDebugCall(this, "public void set(int x, int y, int width, int height, byte[] image) {");
		if (image == null) {
	...
	public boolean isMutable() {
		Object3D.KarinDebugCall(this, "public boolean isMutable() {");
		return _isMutable(handle);
	}

	public int getFormat() {
		Object3D.KarinDebugCall(this, "public int getFormat() {");
		return _getFormat(handle);
	}

	public int getWidth() {
		Object3D.KarinDebugCall(this, "public int getWidth() {");
		return _getWidth(handle);
	}

	public int getHeight() {
		Object3D.KarinDebugCall(this, "public int getHeight() {");
	...
	private static int getBytesPerPixel(int format) {
		Object3D.KarinDebugCall(null, "private static int getBytesPerPixel(int format) {");
		switch (format) {
			case ALPHA:
				return 1;
			case LUMINANCE:
	...
	private static long checkAndCreate(int format, Object image) {
		Object3D.KarinDebugCall(null, "private static long checkAndCreate(int format, Object image) {");
		if (image == null) {
			throw new NullPointerException();
		}
...
//          return tempHandle;
	...
	private static long createHandle(int format, int width, int height, byte[] image) {
		Object3D.KarinDebugCall(null, "private static long createHandle(int format, int width, int height, byte[] image) {");
		Platform.heuristicGC();
	...
	private static long createHandle(int format,
									...
									byte[] image,
									byte[] palette) {
		Object3D.KarinDebugCall(null, "private static long createHandle(int format, int width, int height, byte[] image, byte[] palette) {");
		Platform.heuristicGC();
	...
	private static long createHandle(int format, int width, int height) {
		Object3D.KarinDebugCall(null, "private static long createHandle(int format, int width, int height) {");
		Platform.heuristicGC();
