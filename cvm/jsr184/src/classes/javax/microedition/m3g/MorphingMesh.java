...
public class MorphingMesh extends Mesh {
	...
	public MorphingMesh(
		...
		Object3D.KarinDebugCall(this, "public MorphingMesh( VertexBuffer base, VertexBuffer[] targets, IndexBuffer triangles, Appearance appearance) {");
	...
	public MorphingMesh(
		...
		Object3D.KarinDebugCall(this, "public MorphingMesh( VertexBuffer base, VertexBuffer[] targets, IndexBuffer[] triangles, Appearance[] appearances) {");
		this.targets = new VertexBuffer[targets.length];
		System.arraycopy(targets, 0, this.targets, 0, targets.length);
	}
	...
	MorphingMesh(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "MorphingMesh(long handle) {");
	...
	public VertexBuffer getMorphTarget(int index) {
		Object3D.KarinDebugCall(this, "public VertexBuffer getMorphTarget(int index) {");
		return targets[index];
	}

	public int getMorphTargetCount() {
		Object3D.KarinDebugCall(this, "public int getMorphTargetCount() {");
		return _getMorphTargetCount(handle);
	}

	public void setWeights(float[] weights) {
		Object3D.KarinDebugCall(this, "public void setWeights(float[] weights) {");
		_setWeights(handle, weights);
	}

	public void getWeights(float[] weights) {
		Object3D.KarinDebugCall(this, "public void getWeights(float[] weights) {");
	...
	static long createHandle(VertexBuffer base,
							...
							IndexBuffer triangles,
							Appearance appearance) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer base, VertexBuffer[] targets, IndexBuffer triangles, Appearance appearance) {");
	...
	static long createHandle(VertexBuffer base,
							...
							IndexBuffer[] triangles,
							Appearance[] appearances) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer base, VertexBuffer[] targets, IndexBuffer[] triangles, Appearance[] appearances) {");
