...
//k import javax.microedition.util.ContextHolder;
import sun.misc.MIDPLauncher;
...
class ContextHolder
{
	public static InputStream getResourceAsStream(Class clazz, String name)
	{
		...
		findName = name.charAt(0) == '/' ? name.substring(1) : name;
		suitePath = MIDPLauncher.getMidletSuitePath();
		...
		try
		{
			...
			*/
			entry = zipFile.getEntry(findName);
			if(entry != null)
			{
				System.out.println("zip file found -> " + findName);
				if(!entry.isDirectory())
				{
					is = zipFile.getInputStream(entry);
					oriLen = (int)entry.getSize();
					bytes = new byte[oriLen];
					len = is.read(bytes, 0, oriLen);
					if(len != oriLen)
					{
						bytes = null;
					}
					...
					{
						File testFile = new File("/home/user/cvm/uncompr/" + findName.substring(findName.lastIndexOf('/') + 1));
						System.out.println("/home/user/cvm/uncompr/" + findName.substring(findName.lastIndexOf('/') + 1));
						if(true)
						{
						if(!testFile.exists())
		...
		{
			System.err.println("uncompress zip fail");
			e.printStackTrace();
		}
		finally
		{
...
class StringBuilder
{
	...
	public StringBuilder append(String arg)
	{
		buffer.append(arg);
		return this;
	}
	public StringBuilder append(char arg)
	{
		buffer.append(arg);
		return this;
	}
...
//#endif // RD_JAVA_OMJ
	 ...
	 */
	private Loader() {
		Object3D.KarinDebugCall(this, "private Loader() {");
	...
	private Loader(Vector aFileHistory, String aParentResourceName) {
		Object3D.KarinDebugCall(this, "private Loader(Vector aFileHistory, String aParentResourceName) {");
	...
	public static Object3D[] load(String name) throws IOException {
		Object3D.KarinDebugCall(null, "public static Object3D[] load(String name) throws IOException {");
		if (name == null) {
	...
	public static Object3D[] load(byte[] data, int offset) throws IOException {
		Object3D.KarinDebugCall(null, "public static Object3D[] load(byte[] data, int offset) throws IOException {");
		if (data == null) {
			throw new NullPointerException();
		}
	...
	private Object3D[] loadFromStream(String aName) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] loadFromStream(String aName) throws IOException {");
		if (aName == null) {
			throw new NullPointerException();
		}
	...
	private Object3D[] loadFromByteArray(byte[] aData, int aOffset) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] loadFromByteArray(byte[] aData, int aOffset) throws IOException {");
		if (aData == null) {
	...
	private Object3D[] doLoad(InputStream aStream, int aType) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] doLoad(InputStream aStream, int aType) throws IOException {");
		switch (aType) {
			case M3G_TYPE:
	...
	private Object3D[] loadPNG(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] loadPNG(InputStream aStream) throws IOException {");
	...
	private Object3D[] loadJPEG(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] loadJPEG(InputStream aStream) throws IOException {");
	...
	private Object3D[] buildImage2D(int aColourFormat) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] buildImage2D(int aColourFormat) throws IOException {");
		InputStream stream;
		if (iStreamData == null) {
	...
	private Object3D[] loadM3G(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D[] loadM3G(InputStream aStream) throws IOException {");
	...
	private void setUserObjects() throws IOException {
		Object3D.KarinDebugCall(this, "private void setUserObjects() throws IOException {");
	...
	private void loadExternalRefs(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private void loadExternalRefs(InputStream aStream) throws IOException {");
	...
	private Object3D loadObject(CountedInputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private Object3D loadObject(CountedInputStream aStream) throws IOException {");
		int objectType = readByte(aStream);
		int length = readUInt32(aStream);
	...
	private static final int readByte(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(null, "private static final int readByte(InputStream aStream) throws IOException {");
		return aStream.read();
	}
	...
	private static boolean readBoolean(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(null, "private static boolean readBoolean(InputStream aStream) throws IOException {");
		int b = aStream.read();
		if (b == 0) {
			return false;
		}
	...
	private static final int readUInt32(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(null, "private static final int readUInt32(InputStream aStream) throws IOException {");
		return aStream.read()
				+ (aStream.read() << 8)
				+ (aStream.read() << 16)
				+ (aStream.read() << 24);
	...
	private static String readString(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(null, "private static String readString(InputStream aStream) throws IOException {");
	...
	private int getIdentifierType(InputStream aStream) throws IOException {
		Object3D.KarinDebugCall(this, "private int getIdentifierType(InputStream aStream) throws IOException {");
	...
	private static int getIdentifierType(byte[] aData, int aOffset) {
		Object3D.KarinDebugCall(null, "private static int getIdentifierType(byte[] aData, int aOffset) {");
	...
	private static boolean parseIdentifier(byte[] aData, int aOffset, byte[] aIdentifier) {
		Object3D.KarinDebugCall(null, "private static boolean parseIdentifier(byte[] aData, int aOffset, byte[] aIdentifier) {");
	...
	private boolean inFileHistory(String name) {
		Object3D.KarinDebugCall(this, "private boolean inFileHistory(String name) {");
	...
	private InputStream getHttpInputStream(String name) throws IOException {
		Object3D.KarinDebugCall(this, "private InputStream getHttpInputStream(String name) throws IOException {");
	...
	private InputStream getInputStream(String name) throws IOException {
		Object3D.KarinDebugCall(this, "private InputStream getInputStream(String name) throws IOException {");
	...
	class PeekInputStream extends InputStream {
		...
		PeekInputStream(InputStream aStream, int aLength) {
			Object3D.KarinDebugCall(this, "PeekInputStream(InputStream aStream, int aLength) {");
			iStream = aStream;
		...
		public int read() throws IOException {
			Object3D.KarinDebugCall(this, "public int read() throws IOException {");
		...
		public void increasePeekBuffer(int aLength) {
			Object3D.KarinDebugCall(this, "public void increasePeekBuffer(int aLength) {");
		...
		public int available() throws IOException {
			Object3D.KarinDebugCall(this, "public int available() throws IOException {");
			if (iCounter < iBuffered) {
		...
		//k @Override
		public void close() {
			Object3D.KarinDebugCall(this, "public void close() {");
			try {
				iStream.close();
		...
		public void rewind() throws IOException {
			Object3D.KarinDebugCall(this, "public void rewind() throws IOException {");
			if (iCounter > iBuffered) {
	...
	class CountedInputStream extends InputStream {
		...
		public CountedInputStream(InputStream aStream) {
			Object3D.KarinDebugCall(this, "public CountedInputStream(InputStream aStream) {");
			iStream = aStream;
			resetCounter();
		}
		...
		public void resetCounter() {
			Object3D.KarinDebugCall(this, "public void resetCounter() {");
			iCounter = 0;
		}

		public int getCounter() {
			Object3D.KarinDebugCall(this, "public int getCounter() {");
			return iCounter;
		}
...
//#endif // RD_JAVA_OMJ
	...
	private void registeredFinalize() {
		Object3D.KarinDebugCall(this, "private void registeredFinalize() {");
		if (handle != 0) {
