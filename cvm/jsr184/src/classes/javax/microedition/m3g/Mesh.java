...
public class Mesh extends Node {
	...
	Mesh(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Mesh(long handle) {");
		updateReferences();
	}
	...
	public Mesh(VertexBuffer vertices,
		...
		Object3D.KarinDebugCall(this, "public Mesh(VertexBuffer vertices, IndexBuffer[] triangles, Appearance[] appearances) {");
		updateReferences();
	}
	...
	public Mesh(VertexBuffer vertices,
		...
		Object3D.KarinDebugCall(this, "super(createHandle(vertices, triangles, appearance));");
		updateReferences();
	}
	...
	public void setAppearance(int index, Appearance appearance) {
		Object3D.KarinDebugCall(this, "public void setAppearance(int index, Appearance appearance) {");
		_setAppearance(handle, index, appearance != null ? appearance.handle : 0);
		appearances[index] = appearance;
	}

	public Appearance getAppearance(int index) {
		Object3D.KarinDebugCall(this, "public Appearance getAppearance(int index) {");
		return appearances[index];
	}

	public IndexBuffer getIndexBuffer(int index) {
		Object3D.KarinDebugCall(this, "public IndexBuffer getIndexBuffer(int index) {");
		return triangles[index];
	}

	public VertexBuffer getVertexBuffer() {
		Object3D.KarinDebugCall(this, "public VertexBuffer getVertexBuffer() {");
		return vertices;
	}

	public int getSubmeshCount() {
		Object3D.KarinDebugCall(this, "public int getSubmeshCount() {");
	...
	static void verifyParams(VertexBuffer vertices,
							 IndexBuffer[] triangles,
							 Appearance[] appearances) {
		Object3D.KarinDebugCall(null, "static void verifyParams(VertexBuffer vertices, IndexBuffer[] triangles, Appearance[] appearances) {");
		...
		//k for (IndexBuffer triangle : triangles) {
		for (int i = 0; i < triangles.length; i++) { IndexBuffer triangle = triangles[i];
			if (triangle == null) {
				throw new NullPointerException();
			}
		}
	...
	static void verifyParams(VertexBuffer vertices,
							 IndexBuffer triangles) {
		Object3D.KarinDebugCall(null, "static void verifyParams(VertexBuffer vertices, IndexBuffer triangles) {");
		if (vertices == null || triangles == null) {
			throw new NullPointerException();
		}
	}
	...
	void updateReferences() {
		Object3D.KarinDebugCall(this, "void updateReferences() {");
	...
	static long createHandle(VertexBuffer vertices,
							IndexBuffer[] triangles,
							Appearance[] appearances) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer vertices, IndexBuffer[] triangles, Appearance[] appearances) {");
	...
	static long createHandle(VertexBuffer vertices,
							IndexBuffer triangles,
							Appearance appearance) {
		Object3D.KarinDebugCall(null, "static long createHandle(VertexBuffer vertices, IndexBuffer triangles, Appearance appearance) {");
