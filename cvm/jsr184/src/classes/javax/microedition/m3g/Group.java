...
public class Group extends Node {
	...
	public Group() {
		...
		Object3D.KarinDebugCall(this, "public Group() {");
	}

	Group(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Group(long handle) {");
	...
	public void addChild(Node child) {
		Object3D.KarinDebugCall(this, "public void addChild(Node child) {");
	...
	public void removeChild(Node child) {
		Object3D.KarinDebugCall(this, "public void removeChild(Node child) {");
		if (child != null) {
	...
	public int getChildCount() {
		Object3D.KarinDebugCall(this, "public int getChildCount() {");
		return _getChildCount(handle);
	}

	public Node getChild(int index) {
		Object3D.KarinDebugCall(this, "public Node getChild(int index) {");
	...
	public boolean pick(int mask,
						...
						RayIntersection ri) {
		Object3D.KarinDebugCall(this, "public boolean pick(int mask, float ox, float oy, float oz, float dx, float dy, float dz, RayIntersection ri) {");
	...
	public boolean pick(int mask, float x, float y, Camera camera, RayIntersection ri) {
		Object3D.KarinDebugCall(this, "public boolean pick(int mask, float x, float y, Camera camera, RayIntersection ri) {");
		float[] result = RayIntersection.createResult();
		long hIntersected;
	...
	private void linkChild(Node child) {
		Object3D.KarinDebugCall(this, "private void linkChild(Node child) {");
		if (child == null) {
	...
	private void detachChild(Node child) {
		Object3D.KarinDebugCall(this, "private void detachChild(Node child) {");
		if (children != null) {
