...
public class Appearance extends Object3D {
	...
	public Appearance() {
		...
		Object3D.KarinDebugCall(this, "public Appearance() {");
	}
	...
	Appearance(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "Appearance(long handle) {");
	...
	public void setCompositingMode(CompositingMode compositingMode) {
		Object3D.KarinDebugCall(this, "public void setCompositingMode(CompositingMode compositingMode) {");
	...
	public CompositingMode getCompositingMode() {
		Object3D.KarinDebugCall(this, "public CompositingMode getCompositingMode() {");
		return compositingMode;
	}

	public void setFog(Fog fog) {
		Object3D.KarinDebugCall(this, "public void setFog(Fog fog) {");
		_setFog(handle, fog != null ? fog.handle : 0);
		this.fog = fog;
	}

	public Fog getFog() {
		Object3D.KarinDebugCall(this, "public Fog getFog() {");
		return fog;
	}

	public void setPolygonMode(PolygonMode polygonMode) {
		Object3D.KarinDebugCall(this, "public void setPolygonMode(PolygonMode polygonMode) {");
		_setPolygonMode(handle, polygonMode != null ? polygonMode.handle : 0);
		this.polygonMode = polygonMode;
	}

	public PolygonMode getPolygonMode() {
		Object3D.KarinDebugCall(this, "public PolygonMode getPolygonMode() {");
		return polygonMode;
	}

	public void setLayer(int index) {
		Object3D.KarinDebugCall(this, "public void setLayer(int index) {");
		_setLayer(handle, index);
	}

	public int getLayer() {
		Object3D.KarinDebugCall(this, "public int getLayer() {");
		return _getLayer(handle);
	}

	public void setMaterial(Material material) {
		Object3D.KarinDebugCall(this, "public void setMaterial(Material material) {");
		_setMaterial(handle, material != null ? material.handle : 0);
		this.material = material;
	}

	public Material getMaterial() {
		Object3D.KarinDebugCall(this, "public Material getMaterial() {");
		return material;
	}

	public void setTexture(int unit, Texture2D texture) {
		Object3D.KarinDebugCall(this, "public void setTexture(int unit, Texture2D texture) {");
	...
	public Texture2D getTexture(int unit) {
		Object3D.KarinDebugCall(this, "public Texture2D getTexture(int unit) {");
