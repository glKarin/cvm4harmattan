...
public class TriangleStripArray extends IndexBuffer {
	...
	public TriangleStripArray(int firstIndex, final int[] stripLengths) {
		super(_createImplicit(Interface.getHandle(),
				firstIndex,
				stripLengths));
		Object3D.KarinDebugCall(this, "public TriangleStripArray(int firstIndex, final int[] stripLengths) {");
	}
	...
	public TriangleStripArray(final int[] indices, final int[] stripLengths) {
		...
		Object3D.KarinDebugCall(this, "public TriangleStripArray(final int[] indices, final int[] stripLengths) {");
	}

	TriangleStripArray(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "TriangleStripArray(long handle) {");
	}
	...
	public int getIndexCount() {
		Object3D.KarinDebugCall(this, "public int getIndexCount() {");
		return _getIndexCount(handle);
	}

	//k @Override
	public void getIndices(int[] indices) {
		Object3D.KarinDebugCall(this, "public void getIndices(int[] indices) {");
