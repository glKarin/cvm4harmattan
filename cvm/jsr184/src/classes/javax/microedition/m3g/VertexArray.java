...
public class VertexArray extends Object3D {
	...
	public VertexArray(int numVertices, int numComponents, int componentSize) {
		super(createHandle(numVertices,
				numComponents,
				componentSize));
		Object3D.KarinDebugCall(this, "public VertexArray(int numVertices, int numComponents, int componentSize) {");
	}
	...
	VertexArray(long handle) {
		super(handle);
		Object3D.KarinDebugCall(this, "VertexArray(long handle) {");
	}
	...
	public void set(int startIndex, int length, short[] values) {
		Object3D.KarinDebugCall(this, "public void set(int startIndex, int length, short[] values) {");
		_setShort(handle, startIndex, length, values);
	}

	public void set(int startIndex, int length, byte[] values) {
		Object3D.KarinDebugCall(this, "public void set(int startIndex, int length, byte[] values) {");
	...
	public void get(int firstVertex, int numVertices, byte[] values) {
		Object3D.KarinDebugCall(this, "public void get(int firstVertex, int numVertices, byte[] values) {");
		_getByte(handle, firstVertex, numVertices, values);
	}

	public void get(int firstVertex, int numVertices, short[] values) {
		Object3D.KarinDebugCall(this, "public void get(int firstVertex, int numVertices, short[] values) {");
	...
	public int getComponentType() {
		Object3D.KarinDebugCall(this, "public int getComponentType() {");
	...
	private static long createHandle(int numVertices, int numComponents, int componentSize) {
		Object3D.KarinDebugCall(null, "private static long createHandle(int numVertices, int numComponents, int componentSize) {");
