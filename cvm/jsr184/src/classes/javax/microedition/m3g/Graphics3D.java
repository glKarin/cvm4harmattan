...
class Rect
{
	...
	public void FromGraphicsClip(Graphics g)
	{
		int bounds[];
...
public class Graphics3D {
	...
	private class Destroyer {
		...
		Destroyer(Graphics3D g3d) {
			Object3D.KarinDebugCall(this, "Destroyer(Graphics3D g3d) {");
			target = g3d;
		}

		// This method gets called when application is shuttingdown
		public void shuttingDown() {
			Object3D.KarinDebugCall(this, "public void shuttingDown() {");
	...
	public static final Graphics3D getInstance() {
		Object3D.KarinDebugCall(null, "public static final Graphics3D getInstance() {");
	...
	public static void initGraphics3D() {
		Object3D.KarinDebugCall(null, "public static void initGraphics3D() {");
		s_instance = null;
	}

	private Graphics3D() {
		Object3D.KarinDebugCall(this, "private Graphics3D() {");
	...
	public void bindTarget(java.lang.Object target) {
		Object3D.KarinDebugCall(this, "public void bindTarget(java.lang.Object target) {");
	...
	public void bindTarget(java.lang.Object target, boolean depth, int flags) {
		Object3D.KarinDebugCall(this, "public void bindTarget(java.lang.Object target, boolean depth, int flags) {");
		integrityCheck();
		...
		if (target instanceof Graphics) {
			System.out.println(">>>>>>>>>>>>>>>>>>>>>> bind graphics: " + target);
			//k cvm
			final Graphics finalG = (Graphics) target;
			final Rect bounds = new Rect();
			bounds.FromGraphicsClip(finalG);
			if(buffer == null)
				buffer = new Bitmap();
			// UNUSED: using cvm frame buffer size and memory.
			final int width = 0;
			final int height = 0;
			...
			*/
			...
			cur_height = height;
			int size[] = new int[2];
			Object creator = finalG.GetGraphicsCreator(size);
			if(creator == null || creator instanceof javax.microedition.lcdui.Canvas)
			{
				cur_width = size[0];
				cur_height = size[1];
				System.out.println(">>>>>>>>>>>>>>>>>>>>>> graphics creator: " + creator + ", w=" + size[0] + ", h=" + size[1]);
			}
			System.out.println("bind finished -> " + currentTarget);
		} else if (target instanceof Image2D) {
			System.out.println(">>>>>>>>>>>>>>>>>>>>>> bind image2d: " + target);
	...
	public void releaseTarget() {
		Object3D.KarinDebugCall(this, "public void releaseTarget() {");
		integrityCheck();
		if (currentTarget == null) {
			return;
		}
	...
	public void setViewport(int x, int y, int width, int height) {
		Object3D.KarinDebugCall(this, "public void setViewport(int x, int y, int width, int height) {");
		integrityCheck();
		if (width <= 0 || height <= 0
	...
	public void clear(Background background) {
		Object3D.KarinDebugCall(this, "public void clear(Background background) {");
		integrityCheck();
	...
	public void render(World world) {
		Object3D.KarinDebugCall(this, "public void render(World world) {");
		integrityCheck();
		...
		Platform.executeInUIThread(
				new M3gRunnable() {
					...
					public void doRun() {
						try{
							System.out.println("rederworldddddddddddddddddddd");
							_renderWorld(handle, finalWorld.handle);
						}
						catch(Exception e)
						{
							System.out.println("eeeeeeeeeeeeeeeeerederworldddddddddddddddddddd");
							e.printStackTrace();
						}
					}
				});
	...
	public void render(VertexBuffer vertices,
					   ...
					   Transform transform) {
		Object3D.KarinDebugCall(this, "public void render(VertexBuffer vertices, IndexBuffer primitives, Appearance appearance, Transform transform) {");
	...
	public void render(VertexBuffer vertices,
					   ...
					   Transform transform,
					   int scope) {
		Object3D.KarinDebugCall(this, "public void render(VertexBuffer vertices, IndexBuffer primitives, Appearance appearance, Transform transform, int scope) {");
	...
	public void render(Node node, Transform transform) {
		Object3D.KarinDebugCall(this, "public void render(Node node, Transform transform) {");
	...
	public void setCamera(Camera camera, Transform transform) {
		Object3D.KarinDebugCall(this, "public void setCamera(Camera camera, Transform transform) {");
		integrityCheck();
		_setCamera(handle,
	...
	public int addLight(Light light, Transform transform) {
		Object3D.KarinDebugCall(this, "public int addLight(Light light, Transform transform) {");
		integrityCheck();
	...
	public void setLight(int index, Light light, Transform transform) {
		Object3D.KarinDebugCall(this, "public void setLight(int index, Light light, Transform transform) {");
		integrityCheck();
		_setLight(handle,
				index,
	...
	public void resetLights() {
		Object3D.KarinDebugCall(this, "public void resetLights() {");
		integrityCheck();
		_resetLights(handle);
	...
	public static final Hashtable getProperties() {
		Object3D.KarinDebugCall(null, "public static final Hashtable getProperties() {");
	...
	public void setDepthRange(float near, float far) {
		Object3D.KarinDebugCall(this, "public void setDepthRange(float near, float far) {");
		integrityCheck();
	...
	public Camera getCamera(Transform transform) {
		Object3D.KarinDebugCall(this, "public Camera getCamera(Transform transform) {");
		integrityCheck();
		if (transform != null) {
	...
	public float getDepthRangeFar() {
		Object3D.KarinDebugCall(this, "public float getDepthRangeFar() {");
		integrityCheck();
		return _getDepthRangeFar(handle);
	}

	public float getDepthRangeNear() {
		Object3D.KarinDebugCall(this, "public float getDepthRangeNear() {");
		integrityCheck();
		return _getDepthRangeNear(handle);
	}

	public Light getLight(int index, Transform transform) {
		Object3D.KarinDebugCall(this, "public Light getLight(int index, Transform transform) {");
		integrityCheck();
	...
	public int getLightCount() {
		Object3D.KarinDebugCall(this, "public int getLightCount() {");
		integrityCheck();
		return _getLightCount(handle);
	}

	public java.lang.Object getTarget() {
		Object3D.KarinDebugCall(this, "public java.lang.Object getTarget() {");
		return currentTarget;
	}

	public int getViewportHeight() {
		Object3D.KarinDebugCall(this, "public int getViewportHeight() {");
		integrityCheck();
		return _getViewportHeight(handle);
	}

	public int getViewportWidth() {
		Object3D.KarinDebugCall(this, "public int getViewportWidth() {");
		integrityCheck();
		return _getViewportWidth(handle);
	}

	public int getViewportX() {
		Object3D.KarinDebugCall(this, "public int getViewportX() {");
		integrityCheck();
		return _getViewportX(handle) - offsetX;
	}

	public int getViewportY() {
		Object3D.KarinDebugCall(this, "public int getViewportY() {");
		integrityCheck();
		return _getViewportY(handle) - offsetY;
	}

	public int getHints() {
		Object3D.KarinDebugCall(this, "public int getHints() {");
		return hints;
	}

	public boolean isDepthBufferEnabled() {
		Object3D.KarinDebugCall(this, "public boolean isDepthBufferEnabled() {");
		return depthEnabled;
	}
	...
	private void integrityCheck() {
		Object3D.KarinDebugCall(this, "private void integrityCheck() {");
		if (iInterface == null) {
		System.out.println("integrityCheck startttttttttinterface is null");
			throw new RuntimeException("Graphics3D closed");
		}
		if (!iNativeInitialized) {
		System.out.println("integrityCheck startttttttttnative is not init");
			// If native interface cannot be initialized we cannot recover from it
			if (!initNativePeer()) {
		System.out.println("integrityCheck startttttttttui thread is not init");
				throw new Error("UI thread not available");
			}
		}
		System.out.println("integrityCheck startttttttttENDDDDDDDDDD");
	}
	...
	private boolean initNativePeer() {
		Object3D.KarinDebugCall(this, "private boolean initNativePeer() {");
		if (iNativeInitialized) {
			return true;
		}
