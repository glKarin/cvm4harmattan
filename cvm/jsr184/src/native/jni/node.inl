...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aWhich)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aId)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jlong aHTarget, jbyteArray aDstArray)
{
    jboolean ret = 0;
...
(JNIEnv* aEnv, jclass _unused, jlong aHNode, jlong aHRef)
{
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jfloat aAlphaFactor)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aWhich, jboolean aEnabled)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jlong aHZReference, jint aZTarget, jlong aHYReference, jint aYTarget)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aAxis)
{
    M3G_DO_LOCK
