...
(JNIEnv* aEnv, jclass _unused, jlong aHController, jint aWorldTime)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHController, jfloat aWeight)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHController, jint aWorldTimeMin, jint aWorldTimeMax)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHController)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHController, jfloat aTime, jint aWorldTime)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHController, jfloat aFactor, jint aWorldTime)
{
    M3G_DO_LOCK
