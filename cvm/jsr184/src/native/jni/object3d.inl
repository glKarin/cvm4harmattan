...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jint aTime)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jint aIndex)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jint aUserID)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jlong aHTrack)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jlongArray aHReferences)
{
    jlong* references = NULL;
    if (aHReferences)
    {
        references = (*aEnv)->GetLongArrayElements(aEnv, aHReferences, NULL);
        if (references == NULL)
        {
    ...
    if (references)
    {
        (*aEnv)->ReleaseLongArrayElements(aEnv, aHReferences, references, 0);
    }
...
(JNIEnv* aEnv, jclass _unused, jlong aHObject, jlongArray aHReferences)
{
    ...
    jint numReferences = aHReferences ? (*aEnv)->GetArrayLength(aEnv, aHReferences) : 0;
