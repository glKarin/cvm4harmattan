...
(JNIEnv* aEnv, jclass _unused, jlong aHPolygonMode, jint aModeBits)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHPolygonMode)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHPolygonMode, jboolean aEnable)
{
    M3G_DO_LOCK
