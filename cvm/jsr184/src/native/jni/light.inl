...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jfloat aExponent)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jfloat aConstant, jfloat aLinear, jfloat aQuadratic)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jfloat aIntensity)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aType)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jfloat aAngle)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHandle, jint aRGB)
{
    M3G_DO_LOCK
