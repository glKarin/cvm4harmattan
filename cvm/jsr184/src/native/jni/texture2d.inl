...
(JNIEnv* aEnv, jclass _unused, jlong aHTexture2D)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTexture2D, jint aLevelFilter, jint aImageFilter)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTexture2D, jint aRGB)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aM3g, jlong aHImage)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTexture2D, jint aWrapS, jint aWrapT)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTex, jlong aHImg)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTexture2D, jint aFunc)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv, jclass _unused, jlong aHTex)
{
    M3G_DO_LOCK
