                              ...
                              M3Gint patchIndex)
{
    ...
    qglTexEnvx(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, (GLfixed) GL_MODULATE);
    ...
    qglLoadIdentity();
    qglScalef(m3gRcp((M3Gfloat) m3gGetWidth(sprite->image)),
...

    {
        ...
        qglColor4x((GLfixed) 1 << 16, (GLfixed) 1 << 16, (GLfixed) 1 << 16, a);
    }
       ...
       the fog distance will be calculated correctly in the OpenGL pipeline. */
    {
        ...
        qglMultMatrixf(scaleW);

        qglMatrixMode(GL_PROJECTION);
        m3gGetMatrixColumns(projMatrix, transform);
        qglLoadMatrixf(transform);
    }
#endif
