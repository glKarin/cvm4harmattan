...
// log func ptr
#define PRINT_EGL_ERROR_DEVICE stderr
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglGetDisplay(0x%X)", display_id);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglQueryString(0x%X, 0x%X)", dpy, name);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglGetConfigAttrib(0x%X, 0x%X, 0x%X, %p)", dpy, config, attribute, value);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglQuerySurface(0x%X, 0x%X, 0x%X, %p)", dpy, surface, attribute, value);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglSurfaceAttrib(0x%X, 0x%X, 0x%X, %d)", dpy, surface, attribute, value);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglGetCurrentSurface(0x%X0", readdraw);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglQueryContext(0x%X, 0x%X, 0x%X, %p)", dpy, ctx, attribute, value);
...
{
	fprintf(PRINT_EGL_CALL_DEVICE, "eglWaitNative(0x%X)", engine);
