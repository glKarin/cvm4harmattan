...
#   else /* !M3G_NGL_CONTEXT_API */
    ...
    */
	...
	printf("[Harmattan]: OpenGL vendor: %s, renderer: %s, version: %s, extensions: %s\n", qglGetString(GL_VENDOR), qglGetString(GL_RENDERER), qglGetString(GL_VERSION), qglGetString(GL_EXTENSIONS));
	printf("2 %p|1 %p| %p\n", glActiveTexture, qglEnableClientState, qglActiveTexture);
