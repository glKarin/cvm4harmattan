 ...
 */
static void errorHandler(M3Genum errorCode, M3GInterface _unused /*m3g*/)
{
#ifdef __cplusplus //harmattan
    CSynchronization::InstanceL()->SetErrorCode(errorCode);
#else
    CSynchronization__InstanceL()->SetErrorCode(CSynchronization__InstanceL(), errorCode);
#endif
}
 ...
 */
JNIEXPORT jlong JNICALL Java_javax_microedition_m3g_Interface__1ctor(JNIEnv* aEnv, jclass _unused)
{
	...
	printf("[Harmattan]: load OpenGLES v1 library -> %d\n", karinGLInit());
