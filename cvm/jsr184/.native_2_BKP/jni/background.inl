...
(JNIEnv* aEnv,   jclass _unused, jlong aHandle, jint aCropX, jint aCropY, jint aWidth, jint aHeight)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHandle, jint aModeX, jint aModeY)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHandle, jlong aHImage)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHandle, jint aARGB)
{
    M3G_DO_LOCK
...
(JNIEnv* aEnv,   jclass _unused, jlong aHandle, jint aWhich, jboolean aEnable)
{
    M3G_DO_LOCK
