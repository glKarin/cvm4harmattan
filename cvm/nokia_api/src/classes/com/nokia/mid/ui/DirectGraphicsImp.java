...
public class DirectGraphicsImp implements DirectGraphics{
	...
	private static int PIXEL_FORMAT_TYPE = TYPE_USHORT_565_RGB;
	...
	public void setARGBColor(int argb) {
		...
		*/
		graphics.setColor(argb & 0x00ffffff); // TODO
	}
	...
	public void getPixels(byte pix[], byte alpha[], int offset, int scanlen, int x, int y, int width, int height,
			int format) {
		//TODO Log.e(TAG, "public void getPixels(byte pix[], byte alpha[], int offset, int scanlen, int x, int y, int width, int height, int format)");
	}
