...
class LocationProviderKML extends LocationProviderSimplified {
	 ...
	 */
	LocationProviderKML(Criteria criteria, String source) throws LocationException {
		TTUtils.log("OpenLAPI KML mode");
		this.source = source;
		startBackend();
	}
	...
	protected void startBackend() throws LocationException {
		...
		try {
			...
			// TODO: allow interval to be defined during construction or in KML
			long interval = 2000;
			daemon = new TrailDaemon(locations, interval);
